        ...
        public bool SendEmail(string p_Email,string p_Password, string FirstName)
        {
            try
            {
                ...
                using (var message = new MailMessage(new MailAddress(ConfigurationManager.AppSettings["AdminId"], "Admin"), new MailAddress(p_Email, "user"))
                {
                    ...
                    Body = "Hello "+ FirstName + ",<br/><br/>Below are the login credentials for the system <br/><br/>Username: " + p_Email + " <br/>Password: " + p_Password + "<br/><br/>Please <a href=" + ConfigurationManager.AppSettings["LoginUrl"] + ">Click Here</a> to login <br/><br/><br/>Regards<br/>Admin"
                })
                {
